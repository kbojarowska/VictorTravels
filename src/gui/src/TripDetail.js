        ...
        <div className="details-screen">
          ...
          <div className="details-body">
            ...
            <div className="details-column">
              ...
              <div id="Osoby">
                <div>
                  <CounterComp getValue={handleParentInputChange} parentId={1} text="Dorośli" />
                </div>
                <div>
                  <CounterComp
                    getValue={handleParentInputChange}
                    parentId={2}
              ...
              <input
                ...
                onChange={(e) => {
                  setOwnTransportTo(e.target.checked);
                }}
              />
              <TransportBooking
                locations={trip.to}
              ...
              <div>{selectedRoom && <p>Selected room: {selectedRoom}</p>}</div>
              <h3>Cena:</h3>
